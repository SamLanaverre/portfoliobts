...
<?php include_once("partials/barrenav.php") ?>
          ...
          <div class="col-12">
            <header>
              ...
              <p class="mx-auto tm-banner-subtitle">
                Portfolio dans le cadre du BTS SIOes
              </p>
            </header>
          </div>
        </div>
    ...
    <!-- Features/BTS SIO -->
    <div class="container tm-features-section" id="BTS_SIO">
      <div class="row tm-features-row">
        <section class="col-md-6 col-sm-12 tm-feature-block">
          <header class="tm-feature-header">
            ...
            <h3 class="tm-feature-h">Présentation : </h3>
          </header>
          <p>
            Je m'appelle Sam Lanaverre et je prépare 
          </p>
          <p>
